  ...
  return (
    <main className="mx-auto max-w-4xl px-5 py-8 sm:px-8">
      <header className="mb-7 flex items-center gap-3 border-b border-slate-300 pb-5">
        ...
        <span className="ml-auto text-sm text-slate-600">このPCの設定</span>
      </header>
...
export default function LocalLoginSettings() {
  if (window.location.hostname !== '127.0.0.1') {
    return <main className="mx-auto max-w-3xl p-6"><a href={window.location.pathname.replace(/\/local-login\/?$/, '/')} className="text-sm text-blue-700 underline">管理画面に戻る</a><LocalLoginGuide /></main>
  }
