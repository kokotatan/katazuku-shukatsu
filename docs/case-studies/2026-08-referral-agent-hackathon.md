...
当初は「45日ごとの未接触検知」を中心にした。しかし調査と対話を通して、固定周期の通知よりも次の問題が重要だと分かった。
...
本来は「過去に本気で欲しかった中途候補一人を再活性化する」に絞るべきだった。最終デモでは、45日運用、再活性化、候補探索、月次報告、強制措置まで含め、焦点が薄まった。
