...
const PLATFORM_DOMAIN_RE =
  /goodfind|slogan\.jp|typeshukatsu|bizreach|br-campus|en-?courage|labbase|openwork|gaishishukatsu|gakujo|re-katsu|offerbox|mynavi|rikunabi|onecareer|unistyle|careerpark|kimisuka|wantedly|athletics|irodas|abuild|ibeck|minshu\.co|nikki\.ne\.jp/i
