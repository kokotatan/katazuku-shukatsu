...
const STEP_RULES: { re: RegExp; step: string }[] = [
  ...
  { re: /Slack.{0,25}(招待|ご?参加|ワークスペース)/i, step: 'Slackに参加' },
  { re: /(AIツール|ツール|PC環境|環境).{0,15}(セットアップ|構築|インストール|確認)/, step: 'ツール・環境をセットアップ' },
  { re: /事前(課題|タスク|準備|アンケート)/, step: '事前準備を完了' },
  { re: /(宿泊|交通費).{0,15}(手配|申請|案内|入力)/, step: '宿泊・交通費の手続き' },
