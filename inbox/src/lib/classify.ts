...
const CATEGORY_RULES: { category: Category; re: RegExp }[] = [
  ...
  {
    category: 'task',
    re: /エントリーシート|ES|課題(?!解決)|提出|Webテスト|WEBテスト|適性検査|SPI|玉手箱|受検|受験のお願い|書類選考に進むため|アンケート|応募手続/,
  },
  {
    category: 'event',
...
const ACTION_RE =
  /ご?返信|ご?回答|日程.{0,10}(調整|登録|選択|入力|予約)|候補日.{0,10}(お知らせ|ご連絡|入力|選択)|ご?提出|受検|ご?受験|ご?予約|お申し?込み|出欠|ご都合|お手続き|ご連絡(を?お待ち|ください)|再調整|エントリー(をお願い|フォーム)/
