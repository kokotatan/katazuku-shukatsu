...
$launcher = Join-Path $PSScriptRoot 'run-mail-watch.vbs'
...
"タスク 'katazuku-mail-watch' を登録しました(毎日07:15〜22:15、1時間おき、ウィンドウ非表示で実行)。"
"手動テスト: powershell -NoProfile -ExecutionPolicy Bypass -File `"$PSScriptRoot\mail-watch.ps1`""
